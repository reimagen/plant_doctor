...
export const TEST_PLANTS: Plant[] = [
  ...
  // HEALTHY - Green badge, water in 5 days
  {
    ...
    photoUrl: 'https://images.pexels.com/photos/5978608/pexels-photo-5978608.jpeg?auto=compress&cs=tinysrgb&w=800',
    location: 'Bookshelf',
  ...
  // MONITORING - Amber badge, water today (watering day)
  {
    ...
    photoUrl: 'https://images.pexels.com/photos/4593961/pexels-photo-4593961.jpeg?auto=compress&cs=tinysrgb&w=800',
    location: 'Bedroom',
  ...
  // 4. Only after all phase-1 complete does status flip to "Monitoring" (warning status)
  {
    ...
    photoUrl: 'https://images.unsplash.com/photo-1598880940080-ff9a29891b85?q=80&w=800&auto=format&fit=crop',
